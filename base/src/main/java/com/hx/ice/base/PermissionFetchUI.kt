...
import com.hx.ice.base.PermissionUtils.isOpenPermisson
import com.hx.ice.base.PermissionUtils.openPermission
import com.hx.ice.base.PermissionUtils.showPermissions
...
class PermissionFetchUI : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        psn = intent.getStringArrayExtra("psn") as Array<String>
        permissionName = intent.getStringExtra("permissionName").toString()
